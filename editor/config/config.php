...
SpawConfig::setStaticConfigItem('SPAW_DIR', '/editor/');
SpawConfig::setStaticConfigItem('SPAW_FOR_FILES', '/files/');
...
SpawConfig::setStaticConfigItem("table_styles",
  array(
    'table' => 'Normal',
    'noborder' => 'Без рамки',
    'smalltext' => 'Мелкий шрифт',
	'tableleft' => 'Смещение влево',
	'tableright' => 'Смещение вправо',
  )
);
...
SpawConfig::setStaticConfigItem("quick_links",
  array(
    'http://президент.рф/' => 'Президент Российской Федерации',
    'http://www.government.ru/' => 'Правительство Российской Федерации',
    'http://www.orel-region.ru/' => 'Портал Орловской области',
	'http://www.blog.orel-region.ru/' => 'Блог Губернатора',
	'http://www.uchimvas.ru/' => 'Центр Интернет-образования'
...
SpawConfig::setStaticConfigItem(
  ...
  array(
   /* array(
    ...
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_FOR_FILES').'uploads/images/',
      'caption' => 'Images',
      'params'  => array(
    ...
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_FOR_FILES').'uploads/files/',
